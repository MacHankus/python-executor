...
import { WithStyles } from '@material-ui/core'
import { createStyles, TextFieldProps } from '@material-ui/core'
...
const eom: EqualityOperatorManagerInterface = new EqualityOperatorManager()
class ApiTextInput extends ApiInputAbstract<WithStyles<typeof styles>,{}>{
    equalityList = [
             eom.like(),
             eom.eq()
         ]
...
export default withStyles(styles)(ApiTextInput);
